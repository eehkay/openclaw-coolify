...
# Resolve public URL (Coolify injects SERVICE_URL_OPENCLAW_18789 or SERVICE_FQDN_MOLTBOT)
BASE_URL="${SERVICE_FQDN:-${SERVICE_URL_OPENCLAW_18789:-http://localhost:18789}}"
